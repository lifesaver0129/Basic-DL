...
def find_products_with_featureLevel(categoryCode, feature_under_the_category):
    ...
    if len(feature_under_the_category) > 0:
        for ele_feature_under_the_category in feature_under_the_category:
            ...
            data = (categoryCode, '%'+ele_feature_under_the_category+'%', target_productInfoList[8], target_productInfoList[3])
...
#         target_productID = 52165
        ...
        target_product_featureList = target_productInfoList[10].split(';') # given a product, features selected under the category.
...
#         category_numberList = [] # the number of products assigned to each match category.
        ...
        if len(feature_matchList) > 0:# there are feature level matching
            ...
            diff_feature_matchList_parent = list(set(category_matchList) - set(feature_matchList_parent))# category_matchList minus(-) featurelist's parent.
