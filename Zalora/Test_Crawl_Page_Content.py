...
def save_product_data(sql_statement, dataset):
    cursor.execute(sql_statement, dataset)
...
#start crawling product data
start_number_one = 1
while start_number_one < 2:
    # SQL 查询语句
    ...
    #关闭跳出窗口
    click_the_window = driver.find_element_by_xpath('//div[@class="eg-close-step-1 eg-invisibleButton"]')
    if click_the_window is not None:
